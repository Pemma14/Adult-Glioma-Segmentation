...
from src.scripts.prepare_data import ROOT_DIR

from src.scripts.utils.data import load_config, get_folds, get_data_dicts, get_loaders
from src.scripts.utils.config_schema import validate_config, get_required_training_keys
from src.scripts.utils.transforms import get_transforms
from src.scripts.utils.visualization import log_validation_example
...
def main():
    ...
    metadata_path = ROOT_DIR / "data/dev/metadata.csv"
