...
from src.scripts.utils.config_schema import validate_config, get_required_inference_keys
from src.scripts.utils.metrics import compute_dice_per_region, compute_hd95_per_region
from src.scripts.utils.model import (
    load_model_weights,
    resolve_checkpoint_path,
    resolve_ensemble_paths,
    get_checkpoint_best_dice,
)
from src.scripts.utils.output import save_prediction, save_uncertainty_map
from src.scripts.utils.transforms import build_postprocess_transform, ConvertToMultiChannelMSDd
from src.scripts.utils.tta import get_tta_variant_count, tta_sliding_window_inference
from src.scripts.utils.visualization import (
    plot_dice_summary,
    plot_hd95_summary,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run 3D glioma segmentation inference on dev MSD/UPENN cases.")
    ...
    parser.add_argument("--metadata", type=str, default="data/dev/metadata.csv", help="Path to metadata.csv")
    parser.add_argument("--data_dir", type=str, default="data/dev", help="Processed data root")
